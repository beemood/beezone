export type ModelSchema = {
  ...
  relations?: Partial<Record<PropertyNames, RelationPropertyOptions>>;
  required?: PropertyNames[];
  unique?: PropertyNames[];
  hash?: PropertyNames[];
  encrypt?: PropertyNames[];
  readOnly?: PropertyNames[];
  writeOnly?: PropertyNames[];
  internal?: boolean;
};
export type GeneratedTypes = 'id' | 'uuid';
...
export type CommonPropertyOptions = {
  ...
  suffixText?: string;
  hints?: string;
  notEqualToProperties?: PropertyNames[];
  isEqualToProperties?: PropertyNames[];
  dependsOnProperties?: PropertyNames[];
  notWithProperties?: PropertyNames[];
  transform?: boolean;
};
...
export type ObjectPropertyOptions = { type?: 'object'; target?: ModelNames };
...
export type RelationPropertyOptions = {
  type?: 'relation';
  target?: ModelNames;
  targetColumnName?: PropertyNames;
  relationColumnName?: PropertyNames;

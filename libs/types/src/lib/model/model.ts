...
export type ModelSchema = {
  ...
  extends?: Names[];
  abstract?: boolean;
  properties?: Partial<Record<Names, PropertyOptions>>;
  relations?: Partial<Record<Names, RelationPropertyOptions>>;
  required?: Names[];
  unique?: Names[];
  hash?: Names[];
  encrypt?: Names[];
...
export type Names =
  ...
  | 'country'
  | 'province';
export type NumberFormats = 'percentage' | 'fraction' | 'positive' | 'negative';
...
export type StringFormats = 'email' | 'password' | 'phone' | 'uuid';
...
export type CommonPropertyOptions = {
  ...
  suffixIcon?: MaterialIcons;
  prefixText?: string;
  suffixText?: string;
  hints?: string;
  notEqualToProperties?: Names[];
  isEqualToProperties?: Names[];
  dependsOnProperties?: Names[];
  notWithProperties?: Names[];
  transform?: boolean;
};
export type DatePropertyOptions = {
  ...
  minDate?: string;
  maxDate?: string;
  generated?: 'created-at' | 'updated-at' | 'deleted-at';
};
...
export type ObjectPropertyOptions = { type?: 'object'; target?: Names };
...
export type StringPropertyOptions = {
  ...
  isIn?: string[];
  notIn?: string[];
  casing?: StringCasings;
  trim?: boolean;
  generated?: 'uuid' | 'barcode';
};

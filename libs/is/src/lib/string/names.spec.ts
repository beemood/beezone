...
describe('names', () => {
  it.each`
    ...
    ${'SoGo'}      | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
    ${'soGo'}      | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
    ${'so Go'}     | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
    ${'so_Go'}     | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
    ${'so-Go'}     | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
    ${'so.Go'}     | ${{ camelCase: 'soGo', kebabCase: 'so-go', pascalCase: 'SoGo', screamingSnakeCase: 'SO_GO', sentenceCase: 'So go', snakeCase: 'so_go', titleCase: 'So Go' } as Names}
